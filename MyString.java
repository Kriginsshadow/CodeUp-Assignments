...
class StringOp{
	...
	public String stringSlice(int start,int len){
		if (start < 0 || start+len > currentString.length() || start>currentString.length()) {   //valid checks befor slicing
			return currentString;
		}
		currentString=currentString.substring(0,start)+currentString.substring(start+len);
		return currentString;
	}
...
class MyString{
    public static void main(String[] args) {
        ...
        while (option != 11) {
			...
			System.out.println("currentString:"+str.currentString);
            ...
            switch (option) {
				...
				case 4:
					...
					break;
				case 5:
					System.out.println("Enter the start and length (s,l) to delete:");
					int start=obj.nextInt();
					int len=obj.nextInt();
					System.out.println("Sliced String:"+str.stringSlice(start,len));
					break;
				case 6:
